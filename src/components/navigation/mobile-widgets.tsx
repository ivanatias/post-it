...
function SearchBox({ closeSearchBox }: SearchBoxProps) {
  return (
    <div className='flex items-center justify-center gap-4 px-10 py-11 absolute top-0 left-0 bg-slate-950 w-full animate-fade-down animate-duration-300 animate-ease-in-out'>
      <button
